...
const TIPOS_FOTOS = [
  ...
  },
  {
    ...
    pasoRelacionado: 10, // ID del paso de cubiertos
  },
  {
    id: "basura",
  ...
  },
  {
    ...
    validacionIA: "interior de cafetera completamente vacía, sin restos de café ni filtros",
    pasoRelacionado: 14, // ID del paso de cafetera
  },
]
          ...
          <CardContent className="space-y-4">
            {tipoFotoRequerida && (
              <div className="space-y-3">
                <div className="p-3 bg-yellow-50 rounded-lg border-0">
                  <h4 className="font-medium text-yellow-800 mb-1">{tipoFotoRequerida.titulo}</h4>
                  <p className="text-sm text-yellow-700">{tipoFotoRequerida.descripcion}</p>
                </div>
